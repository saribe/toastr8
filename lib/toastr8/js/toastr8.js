        ...
        return (function () {
            ...
            var resetOptions = function () {
                ...
                addDomToToastr = function (moodleName, imgClass, logoClass) {
                    ...
                    if (imgClass) html += "<td class='toast8-avatar-container " + imgClass +" '></td>";
                    html += "<td class='toast8-message-container'>" + selector.html() + "</td><td class='toast8-right-container'><button class='toast8-close-button'>×</button><i class='" + logoClass + "'></i></td></tr></tbody></table>";
                    selector.html(html);
                },
